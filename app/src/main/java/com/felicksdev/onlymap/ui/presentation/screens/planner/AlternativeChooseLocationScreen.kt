...
import com.felicksdev.onlymap.ui.presentation.components.topBars.SearchTopBar
...
fun ChooseLocationScreenContent(
    isOrigin: Boolean,
    recentPlaces: List<com.felicksdev.onlymap.domain.Place>,
    onLocationSelected: (com.felicksdev.onlymap.domain.Place) -> Unit,
