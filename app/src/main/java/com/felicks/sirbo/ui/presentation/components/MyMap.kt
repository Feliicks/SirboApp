...
import com.felicks.sirbo.ui.common.rememberScaledWidth
import com.felicks.sirbo.ui.utils.rememberMapPadding
...
fun AnimatedPolyline(
    ...
    duration: Long = 300L // duración total de la animación
) {
