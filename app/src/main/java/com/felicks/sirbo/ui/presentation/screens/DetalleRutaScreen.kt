...
fun DetalleRutaScreen(
    ...
    val bottomSheet = rememberBottomSheetState(
        initialValue = com.felicks.sirbo.ui.common.SheetValue.PartiallyExpanded,
        defineValues = {
            // Bottom sheet height is 100 dp.
            com.felicks.sirbo.ui.common.SheetValue.Collapsed at height(100.dp)
            if (isInitialState) {
                // Offset is 60% which means the bottom sheet takes 40% of the screen.
                com.felicks.sirbo.ui.common.SheetValue.PartiallyExpanded at offset(percent = 60)
            }
            // Bottom sheet height is equal to the height of its content.
            com.felicks.sirbo.ui.common.SheetValue.Expanded at contentHeight
        },
        confirmValueChange = {
            if (isInitialState) {
